...
//                }
    ...
    var Upload = {
        ...
        uploadTpl: '<div class="edui-image-upload%%">' +
            ...
            '<input style=\"filter: alpha(opacity=0);\" multiple="multiple" class="edui-image-file" type="file" hidefocus name="file" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp"/>' +
            '</form>' +
            '</div>',
        ...
        render: function (sel, t) {
            var me = this,
                relatedTable = me.editor.options.relatedTable;//上传其他数据hhq

            $(sel, me.dialog).append($(me.uploadTpl.replace(/%%/g, t).replace(/{{relatedTable}}/g, relatedTable)));
        ...
        uploadComplete: function(r){
            var me = this;
            try{
                var json = eval('('+ r.replace(/<pre .*>|<\/pre>/g,'') +')');
                Base.callback(me.editor, me.dialog, json.data.data, 'SUCCESS');
            }catch (e){
