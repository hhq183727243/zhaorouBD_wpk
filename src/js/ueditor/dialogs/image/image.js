...
(function () {
    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            // WebUploader实例
                uploader,
                actionUrl = editor.getOpt('imageActionName'),//editor.getActionUrl(editor.getOpt('imageActionName')),
                ...
                switch (type) {
                    ...
                    case 'startUpload':
                        ...
                        var params = utils.serializeParam(editor.queryCommandValue('serverparam')) || '',
                            relatedTable = editor.getOpt('relatedTable'),
                            url = actionUrl + '?relatedTable=' + relatedTable;//url = utils.formatUrl(actionUrl + (actionUrl.indexOf('?') == -1 ? '?':'&') + 'encode=utf-8&' + params);
        ...
        getInsertList: function () {
            ...
            for (i = 0; i < this.imageList.length; i++) {
                ...
                list.push({
                    src: prefix + data.data.data,
                    _src: prefix + data.data.data,
                    title: '',
                    alt: '',
                    floatStyle: align
                });
